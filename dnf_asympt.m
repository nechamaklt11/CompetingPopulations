...
%the function recgonizes the index and value of a graph's stabilization point.
...
while true
    ...
    Idx=find(dist<est_noise,1); %(4b) finding the stabilization index
...
CI_low=const-2*noise; CI_high=const+2*noise; %(6) calculating the CI for the estimated constant
CI=[CI_low,CI_high];
